...
> 单元/E2E 用例与规格条目的完整映射原见 e2e/README.md（已随测试体系移除）。
>
> **历史注记（2026-08-18，主规格 v1.9）**：单元测试与 E2E 体系已整体移除，下表涉及单测/覆盖率/E2E
> 的条目仅为历史自查记录，不再适用；质量门禁现为 structure / oxlint / typecheck / build。
