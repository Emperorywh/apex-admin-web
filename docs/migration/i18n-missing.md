...
| 语言 | 命名空间 | 中文 key | 所属页面/组件 | 状态（回退简中 / 已补齐 / 待定） | 登记任务 | 日期 |
| --- | --- | --- | --- | --- | --- | --- |
| zh-TW/ja-JP/ko-KR | profile | profile 命名空间全部键 | Profile 页 | 回退简中（懒加载表无该语言分片，自动回退） | P43 | 2026-09-17 |
| zh-TW/ja-JP/ko-KR | system | system 命名空间全部键 | 模板遗留 system 页 | 回退简中 | 页面任务收口时随页交付 | 2026-09-17 |
