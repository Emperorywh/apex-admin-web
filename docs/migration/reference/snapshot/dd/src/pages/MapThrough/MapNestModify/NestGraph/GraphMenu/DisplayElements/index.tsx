...
/* 国际化翻译方法 */ const { t } = useI18n();
     ...
     */
    const [checkedValues, setCheckedValues] = useState<string[]>(["edgeLabel", "hiddenGrid", "hiddenAngle", "actions", "device", "loadSecurityColor", "freeSecurityColor", "allowVehicleGroupsColor"]);
    ...
    const onChecboxChange: GetProp<typeof Checkbox.Group, "onChange"> = (checkedValues) => {
        ...
        setOverlayVisible({
            ...
            angle: !checkedValues.some(value => value === "hiddenAngle"),
