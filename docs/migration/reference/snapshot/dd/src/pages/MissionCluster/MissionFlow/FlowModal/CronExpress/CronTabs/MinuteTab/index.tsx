...
export default (props: MinuteTabProps) => {
/* 国际化翻译方法 */ const { t } = useI18n();
    ...
    const onRadioChange = (e: RadioChangeEvent) => {
        ...
        switch (value) {
            case "*":
                const every = replaceToZero.toSpliced(cronIndex[text], 1, value).join(" ");
                triggerChange(every);
                break;
            case "fromTo":
                ...
                break;
            case "fromInterval":
                const interval = replaceToZero.toSpliced(cronIndex[text], 1, defaultInterval.current).join(" ");
