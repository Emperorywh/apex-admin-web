    ...
    >
      ...
      >
        ...
        <Input
          ...
          prefix={<UserRound size={18} strokeWidth={1.6} aria-hidden="true" />}
      ...
      >
        ...
        <Input.Password
          className={styles.field}
          prefix={<LockKeyhole size={18} strokeWidth={1.6} aria-hidden="true" />}
          placeholder={t('请输入密码')}
          autoComplete="current-password"
        />
      </Form.Item>
      {/* 提交状态复用认证 Hook，固定按钮高度与宽度，避免加载文案引起布局跳动。 */}
      <Button type="primary" size="large" htmlType="submit" block loading={submitting} aria-busy={submitting} className={styles.submit}>
