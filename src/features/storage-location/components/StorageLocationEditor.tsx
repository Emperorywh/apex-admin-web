...
import {
	...
	storageLocationData,
} from '../storageLocation.model'
import type {
	StorageLocation,
	StorageLocationValues,
} from '../storageLocation.types'
...
export function StorageLocationEditor({
	...
	return (
		<Form<StorageLocationValues>
			form={form}
			layout="horizontal"
			initialValues={record ?? emptyLocation}
			onFinish={onSave}
		...
		>
				...
				<Col xs={24} md={8}>
					...
					>
						<Select
							...
							onChange={() =>
								form.setFieldValue('pointId', undefined)
							}
						/>
					</Form.Item>
				</Col>
			...
			<Flex
				...
				gap={10}
				wrap
				className={styles.parameterHeading}
			>
