...
export function RobotScene({ paused }: RobotSceneProps) {
	...
	return (
		...
		>
			...
			<path
				d="M73 227 370 78 667 227 370 376Z"
				fill={paint('floor')}
				stroke="#25465B"
				strokeOpacity="0.55"
			/>
			<path
				d="M73 227v8l297 149 297-149v-8M370 376v8"
				stroke={paint('edge')}
			/>
			...
			<path
				d="m73 227 25 13m-25-13 25-13m569 13-25 13m25-13-25-13M345 91l25-13 25 13M345 363l25 13 25-13"
				stroke="var(--app-blue-2)"
				strokeOpacity="0.7"
			/>
			...
			<g stroke="#355F75" strokeWidth="0.85" strokeLinejoin="round">
				<path
					d="m145 156 63-32 65 33-63 32Z"
					fill="#152E41"
					fillOpacity="0.65"
				/>
				<path
					d="M145 156v49l65 33v-49ZM210 189l63-32v49l-63 32Z"
					fill={paint('glass')}
				/>
				<path
					d="m145 173 65 33 63-32m-128 15 65 33 63-32M166 167v49m23-38v49m43-49v49m21-60v49"
					opacity="0.64"
				/>
				<path
					d="m153 151 55-28 57 29m-111 58 56 28 55-28"
					strokeDasharray="3 5"
					opacity="0.5"
				/>
				<path
					d="m463 132 65-33 71 36-65 33Z"
					fill="#18384B"
					fillOpacity="0.5"
				/>
				<path
					d="M463 132v56l71 36v-56ZM534 168l65-33v56l-65 33Z"
					fill={paint('glass')}
				/>
				<path
					d="m463 151 71 36 65-33m-136 16 71 36 65-33m-112-29v56m24-44v56m44-55v56m21-67v56"
					opacity="0.7"
				/>
				<path
					d="m489 93 39-20 43 22-39 20Z"
					fill="#112A3E"
					fillOpacity="0.65"
				/>
				<path
					d="M489 93v21l43 22v-21l39-20v21l-39 20"
					fill={paint('glass')}
				/>
				<path
					d="m151 206-19 10 78 39 78-39-17-9m194-15-16 9 85 43 80-41-15-8"
					strokeDasharray="2 5"
					opacity="0.5"
				/>
			</g>
			...
			<path
				d="m144 270 67 34 101-51 70 35 150-76 52 26"
				stroke="var(--app-blue)"
				strokeWidth="1.2"
				strokeOpacity="0.55"
			/>
			...
			/>
			<path
				d="M233 260a124 61 0 0 1 51-49m146 96a124 61 0 0 1-66 14"
				stroke="var(--app-blue-2)"
				strokeOpacity="0.8"
				strokeWidth="1.5"
			/>
			...
			<path
				d="m240 188 95-48a12 12 0 0 1 11 0l116 58q8 4 8 12v27q0 8-8 12l-89 45q-8 4-16 0l-117-59q-7-4-7-11v-24q0-8 7-12Z"
				fill="#12283C"
				stroke="#46667B"
				strokeWidth="1.1"
			/>
			<path
				d="M234 201q0 7 9 12l113 56q9 5 10 15v13l-122-61q-10-5-10-12Z"
				fill={paint('front')}
			/>
			<path
				d="m366 271 98-49q6-3 6-10v24q0 8-8 12l-89 45-7 3Z"
				fill={paint('side')}
			/>
			<path
				d="m240 187 94-47q7-4 14 0l115 58q13 7 0 14l-88 45q-10 5-20 0l-115-57q-12-7 0-13Z"
				fill={paint('deck')}
				stroke="#7894A7"
				strokeWidth="1.1"
			/>
			<path
				d="m244 197 114 57q8 4 15 0l88-45"
				stroke="#A4BFCD"
				strokeOpacity="0.65"
			/>
			<path
				d="m250 184 85-42q6-3 13 1l101 50"
				stroke="#AFCDDB"
				strokeOpacity="0.4"
			/>
			<path
				d="m246 226 103 52m34-3 72-36"
				stroke="#405C70"
				strokeWidth="1.4"
			/>
			<path
				d="m247 239 9 4m47 24 11 5m77 12 21-11"
				stroke="#060F1E"
				strokeWidth="5"
			/>
			...
			<path
				d="m290 194 51-26q6-3 12 0l78 39-63 32Z"
				fill="#0F293D"
				stroke="#52778D"
				strokeWidth="0.9"
			/>
			<path
				d="m303 194 44-22 69 35-49 25Z"
				stroke="#325C73"
				strokeWidth="0.7"
			/>
			<g fill="#7E9BAD">
			...
			<text
				transform="matrix(0.9 0.45 -0.9 0.45 358 204)"
				textAnchor="middle"
				fill="var(--app-text-2)"
				fontSize="18"
				fontWeight="600"
			...
			/>
			<path
				d="M329 145v17c0 7 44 7 44 0v-17Z"
				fill={paint('sensor')}
				stroke="#567B90"
			/>
			<path
				d="M331 153c3 8 36 8 40 0"
				stroke="var(--app-cyan)"
				strokeWidth="3"
				filter={paint('light')}
			/>
			...
			/>
			<path
				d="m253 216 29 15m18 9 40 20"
				stroke="color-mix(in srgb, var(--app-cyan) 30%, white)"
				strokeWidth="2.7"
				strokeLinecap="round"
				filter={paint('light')}
			/>
			<g
				transform="matrix(0.88 -0.44 0 1 393 257)"
				stroke="#071726"
				strokeWidth="2.3"
			>
			...
			<g className={styles.annotations}>
				<path
					d="M350 116V87h-40M473 275h58l28 14"
					stroke="var(--app-text-4)"
					strokeOpacity="0.65"
				/>
				<circle cx="350" cy="116" r="2" fill="var(--app-blue-2)" />
				<circle cx="473" cy="275" r="2" fill="var(--app-blue-2)" />
				<text x="242" y="90" fill="var(--app-text-3)">
					LIDAR
				</text>
				<text x="563" y="295" fill="var(--app-text-2)">
					AGV–01
				</text>
				<text x="95" y="333" fill="var(--app-text-4)" fontSize="8">
